...
@EnableJpaRepositories(basePackages = "com.springboot.ceshi.reporisty1",
        entityManagerFactoryRef = "secondEntityManagerFactoryBean",
transactionManagerRef = "secondTransactionManager")
public class SecondHqslConfig {

    @Bean("secondTransactionManager")
    public JpaTransactionManager transactionManager(@Qualifier("secondEntityManagerFactoryBean") EntityManagerFactory emf) {
